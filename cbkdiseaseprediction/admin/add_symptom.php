...
if($_POST)
{
    $msg = $helper->addSymptom();
}
if($id)
{
    $row = $helper->getSymptom($id);
}
?>
  ...
  <div class="main" role="main">
    <div id="content" class="content page-content full">
      <header class="page-header flexible parallax text-align-center parallax-overlay" style="background-image:url(../images/img4.jpg)">
        <section>
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <h1><?php echo ($id) ? 'Edit' : 'Add'; ?> Symptom</h1>
              </div>
            </div>
          </div>
        </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2><strong><?php echo ($id) ? 'Edit' : 'Add'; ?> Symptom</strong></h2>
            <hr/>
            <?php
            if($msg!='')
            {
              ...
              <div class="row">
                <div class="form-group">
                  <div class="col-md-12">
                    ...
                    <input type="text" id="symptom_name" name="symptom_name" class="form-control input-lg" placeholder="Symptom Name" value="<?php echo $row->symptom_name;?>"/>
                  </div>
                </div>
              </div>
              <div class="row">
