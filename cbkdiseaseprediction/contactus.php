      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <hr/>
            <ul>
              <li><strong><i class="fa fa-map-marker"></i> Address:AZMM Software Solutions</br>
                                                           6996 S/W Street, </br>NYC,
                                                           United States (00001 – 99950).
                                                          </strong> </li>
              <li><strong><i class="fa fa-phone"></i> Phone: +1 (555) 143-6969</strong> </li>
              <li><strong><i class="fa fa-envelope"></i> Email: Info@AZMMsoftwaresolutions.com</strong> </li>
            </ul>
